...
class IdealTrader_Tplus1(OfflineSimulator):
    ...
    def doAppInit(self): # return True if succ
        ...
        self.__fmtr = Formatter_1d518() # Formatter_Snail32x32('/mnt/e/bmp/%s.' % self._tradeSymbol, dem=5) # Formatter_1d518 Formatter_2dImg32x18() # ('/mnt/e/bmp/%s.' % self._tradeSymbol, dem=5) #  = Formatter_Snail32x32() = Formatter_F1548()
