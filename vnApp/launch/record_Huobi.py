...
def runChildProcess(filePath):
    ...
    try:
        ...
        # 解析json文件
        setting = json.load(f)
        setting = setting['gateways'][gwHuobi.gatewayName]
    ...
    me.connect(gwHuobi.gatewayName)
    le.info(u'连接Huobi接口')
...
if __name__ == '__main__':
    runChildProcess('vnApp/conf/Huobi.json')
    # runParentProcess()
